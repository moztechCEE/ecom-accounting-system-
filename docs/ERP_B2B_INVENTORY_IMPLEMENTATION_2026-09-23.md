...
建立：2026-09-23；狀態更新：2026-09-24。資料主權：**Corely ERP 管正式庫存帳**；WMS 管實物揀貨、裝箱與交運證據；ECOUNT 僅供查詢或經核准的會計用途。ERP 客戶入口及庫存基礎功能已部署至 DEV；本輪正式報價、缺貨採購與獨立採購入口已完成程式候選，仍須 DEV 驗證與切流。跨系統交運與核銷在隔離的 0% 流量候選完成一筆合成訂單的 60＋40 件配對試驗。**正式環境及實體倉儲流程尚未驗收。**
...
各節點已有程式，但驗證階段不同：客戶入口、需求送出、人工核庫、接單預留及採購成本在 DEV 基礎版本驗證；正式報價、客戶接受、撤回重核及來源關聯缺貨採購屬本輪候選，待 DEV 端到端驗證；ERP→WMS→交運→核銷僅完成隔離配對的合成 60＋40 件試驗。仍需實際倉管／物流驗收與正式環境切換。裝箱完成不能充當交運或正式扣庫。對 WMS 管理的銷單，ERP 原有「整張銷單立即出庫」入口已加阻擋，正式出庫必須經交運證據與人工核銷。
...
1. **報價及採購 DEV 驗收**：驗證正式報價版次、有效期、客戶接受、撤回後重核、新版與確認接單；再驗缺貨分批採購、收貨後缺口重算、同鍵重送及業務／純採購角色的資料隔離。客戶拒絕報價的獨立動作、報價原單編修與自動 LINE 通知尚未提供。
...
3. **正式報價與缺貨採購候選**：本輪程式新增需求來源的 `SalesQuotation` 版本／客戶接受／未接單撤回，以及來源關聯採購單、獨立缺貨採購與供應商帳號管理頁；要先在隔離 DEV 候選驗證登入、業務與採購權限、客戶隔離、可見畫面及完整流程，才能評估 DEV 切流。正式切換前仍須核對客戶／供應商主檔、價格、SKU 條碼、公司與倉庫、WMS 品牌對照及具名人員 grants，不依 Email 或姓名自動對應。
