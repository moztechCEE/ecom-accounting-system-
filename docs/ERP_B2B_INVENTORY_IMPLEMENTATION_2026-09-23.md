...
建立：2026-09-23；狀態更新：2026-09-24。資料主權：**Corely ERP 管正式庫存帳**；WMS 管實物揀貨、裝箱與交運證據；ECOUNT 僅供查詢或經核准的會計用途。ERP 基礎功能已部署至 DEV；跨系統交運與核銷在隔離的 0% 流量候選完成一筆合成訂單的 60＋40 件配對試驗。**正式環境及實體倉儲流程尚未驗收。**
...
目前 A→J 都有程式實作；A→E 與採購成本已在 DEV 基礎版本驗證，ERP→WMS→交運→核銷已完成隔離配對的合成 60＋40 件試驗。這是技術試驗，仍需實際倉管／物流驗收與正式環境切換。裝箱完成不能充當交運或正式扣庫。對 WMS 管理的銷單，ERP 原有「整張銷單立即出庫」入口已加阻擋，正式出庫必須經交運證據與人工核銷。
